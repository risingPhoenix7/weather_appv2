...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    ...
    MyLocation.shouldSetState.addListener(() async {
      print('should set state was called');
      print(MyLocation.shouldSetState.value);
      await updateTheData();
      MyLocation.shouldSetState.value = false;
    });
  }
